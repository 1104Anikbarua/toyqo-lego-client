  ...
  const handleAddToCart = (lego) => {
    ...
    fetch("https://batch-7-assignment-11-server.vercel.app/carts", {
      ...
      .then((data) => {
        ...
        if (data.insertedId) {
          fetch(
            `https://batch-7-assignment-11-server.vercel.app/legos/${lego?._id}`,
            {
              method: "PATCH",
              headers: {
                "content-type": "application/json",
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center gap-5">
        ...
        <div>
          <h1
            ...
            data-aos-duration="1000"
            data-aos-delay="2800"
            className="font-roboto font-bold text-xl mb-5"
          >
            {legos?.toyName}
          </h1>
          ...
          <div className="flex items-center justify-start gap-5 mb-5">
            ...
            <h3
              ...
              data-aos-duration="1000"
              data-aos-delay="1500"
              className="font-roboto font-medium text-xl line-through text-gray-400/80"
            >
              ${"20"}
            </h3>
          </div>
          ...
          <p
            ...
            data-aos-duration="1000"
            data-aos-delay="700"
            className="font-roboto font-medium text-xl mb-5 w-full max-w-lg"
          >
            {legos?.detail}
          </p>
          <h3
          ...
          <h3
            ...
            className="font-roboto font-medium text-xl mb-5"
          >
            Seller Email: {legos?.sellerEmail}
          </h3>
          <div className="flex items-center mb-5">
            <h3
              ...
              data-aos-duration="500"
              data-aos-delay="100"
              className="font-roboto font-medium text-xl mr-1"
            >
              Color:
            </h3>
            <p
              ...
              data-aos-delay="400"
              className="bg-red-400 w-5 h-5 mr-2"
            ></p>
            <p
              data-aos="fade-right"
              data-aos-easing="ease-in-sine"
              data-aos-duration="500"
              data-aos-delay="700"
              className="bg-blue-500 w-5 h-5 mr-2"
            ></p>
            <p
              data-aos="fade-right"
              data-aos-easing="ease-in-sine"
              ...
              data-aos-delay="1000"
              className="bg-green-600 w-5 h-5 mr-2"
            ></p>
            <p
              data-aos="fade-right"
              data-aos-easing="ease-in-sine"
              ...
              data-aos-delay="1300"
              className="bg-yellow-500 w-5 h-5"
            ></p>
          </div>
          ...
          >
            {isLoading ? (
              <FiLoader className="text-xl animate-spin"></FiLoader>
            ) : (
              "Add To Cart"
            )}
          </button>
          <ul className="text-sm flex items-start justify-start mb-5">
            <p
              ...
              data-aos-duration="500"
              data-aos-delay="100"
              className="font-roboto font-medium text-xl mr-5"
            >
              Payment:
            </p>
            <li className="mr-5">
