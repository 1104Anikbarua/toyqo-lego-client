...
const Counter = () => {
  ...
  return (
    ...
    >
      <div className="w-full mx-auto max-w-7xl text-center overflow-x-hidden mb-5">
        <h1
          data-aos="zoom-in"
        ...
        <div className="stats shadow-2xl flex items-center justify-center">
          <div className="stat">
            <div className="stat-value">
              {counterOn && (
                <Countup start={0} end={1000} duration={9} delay={0}></Countup>
              )}
            </div>
            <div className="stat-desc font-roboto font-bold text-lg text-black">
              {counterOn && (
                <Countup start={0} end={21} duration={17} delay={0}></Countup>
              )}
