                ...
                <form
                    ...
                    <div className='flex flex-col w-full max-w-sm mx-auto'>
                        <label
                            htmlFor="name"
                            className='
                            text-lg font-roboto font-semibold mb-2'>Name</label>
                        <input
                    ...
                    <div className='flex flex-col w-full max-w-sm mx-auto'>
                        ...
                        <input
                            ...
                            className={
                                `bg-blue-100 outline-none rounded-md pl-1 py-1 placeholder:pl-2 ${email ?
                                    emailError ? 'outline-red-500 text-red-500' : 'outline-green-600' : ''}`
                            }
                            type="email"
                            name="email"
                            id="email"
                    ...
                    <div className='flex flex-col w-full max-w-sm mx-auto'>
                        ...
                        <input
                            ...
                            className={
                                ...
                                ${password ? passwordError ? 'outline-red-500 text-red-500' : 'outline-green-600' : ''}`
                            }
                            type="password"
                            name="password"
                            id="password"
