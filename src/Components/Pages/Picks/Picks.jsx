      ...
      {loading ? (
        ...
        <div className="my-32 w-full max-w-7xl mx-auto">
          <h1
            ...
            data-aos-delay="100"
            className="font-roboto font-bold text-center text-7xl mb-5"
          >
              ...
              >
                <div className="rounded-md w-full max-w-sm h-full p-5">
                  ...
                  <button
                    ...
                    data-aos-duration="1000"
                    data-aos-delay="500"
                    className="w-40 rounded-md h-10 mt-5 font-bold text-sm shadow-lg bg-white border border-gray-100"
                  >
                    Shop Now
                  </button>
                </div>
