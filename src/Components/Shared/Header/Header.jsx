      ...
      <div className="flex items-center justify-between">
        ...
        <ul
          className={`flex items-center flex-col absolute duration-700 w-full bg-white lg:bg-opacity-0 shadow-sm justify-center
                md:flex-row md:justify-end md:static md:shadow-none ${
                  show ? "top-[82px]" : "-top-96"
                }`}
        >
      ...
      <div className="hidden md:flex lg:flex items-center justify-center">
        <div
          className={`absolute duration-1000 ${
            click ? "right-[174px] -z-50" : "right-44"
          }`}
        >
          <input
            // style={inputStyle}
            className={`bg-blue-100 outline-none rounded-full pl-2
                        ...
                        ${
                          click
                            ? "w-60 duration-1000 h-10"
                            : "w-0 h-10 duration-1000"
                        }
                        `}
            type="text"
            name=""
          ...
          <HiOutlineSearch
            ...
            className="font-normal text-2xl text-black absolute top-2 right-2 cursor-pointer"
          ></HiOutlineSearch>
        </div>
        <Link
          onClick={() => setClick(!click)}
          ...
          className={`mr-5 z-50 bg-blue-950 rounded-full flex items-center justify-center w-10 h-10 ${
            click ? "hidden" : ""
          }`}
        >
        ...
        <Link to={"cart"} className="z-50">
          ...
          <span className="text-xs text-red-600 font-bold absolute top-5 right-[85px]">
            {totalProduct}
          </span>
        </Link>
      </div>
