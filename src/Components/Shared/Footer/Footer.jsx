  ...
  return (
    <footer className="bg-white shadow-inner py-8 px-5 lg:px-20 my-32">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="p-4">
            ...
            <ul className="text-sm mb-5">
              ...
              >
                Toyqo a Lego Selling Website.Over the years children shape their
                own worlds with LEGO bricks, we play our part in having a
                positive impact on the world they live in today and will inherit
                in the future.
              </p>
              <Link
                data-aos="fade-down"
          ...
          <div className="p-4">
            <h3
              ...
              data-aos-duration="1000"
              data-aos-delay="1100"
              className="font-roboto text-lg font-bold mb-5"
            >
              Contact Us
            </h3>
        ...
        <p className="text-xl font-bold text-center">&copy; Toyqo {year}</p>
      </div>
    </footer>
  );
};
