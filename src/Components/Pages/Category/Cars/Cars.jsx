...
const Cars = () => {
  ...
  useEffect(() => {
    fetch(
      `https://batch-7-assignment-11-server.vercel.app/documents?category=${category}`
    )
      .then((res) => res.json())
      .then((data) => {
        // console.log(data)
      ...
      <div className="text-center mt-2">
        {pages?.map((page) => (
          <button
            ...
            className={`w-10 rounded-md h-10 font-bold text-sm shadow-md bg-white border border-gray-100 ${
